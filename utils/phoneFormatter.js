...
const DEFAULT_COUNTRY_PREFIX = '+964';

/**
 * Formats phone number for WhatsApp
 * WhatsApp requires international format WITH + prefix: +9647XXXXXXXX
 * @param {string} phone - Raw phone number
 * @param {string} countryCode - Country code (default: 964)
 * @returns {string} - Formatted phone number for WhatsApp
 */
export function formatForWhatsApp(phone, countryCode = DEFAULT_COUNTRY_CODE) {
    if (!phone) return '';
 ...
 * @param {string} phone - Raw phone number
 * @param {string} countryCode - Country code (default: 964)
 * @returns {string} - Formatted phone number for Telegram
 */
export function formatForTelegram(phone, countryCode = DEFAULT_COUNTRY_CODE) {
    if (!phone) return '';
 ...
 */
export function formatForSMS(phone, countryCode = DEFAULT_COUNTRY_CODE) {
    if (!phone) return '';
 ...
 * @param {string} phone - Raw phone number
 * @param {string} countryCode - Country code (default: 964)
 * @returns {string} - Formatted phone number for database
 */
export function formatForDatabase(phone, countryCode = DEFAULT_COUNTRY_CODE) {
    if (!phone) return '';
 ...
 */
export function formatForDisplay(phone, countryCode = DEFAULT_COUNTRY_CODE) {
    if (!phone) return '';
 ...
 * @param {string} phone - Raw phone number
 * @param {string} countryCode - Country code (default: 964)
 * @returns {string} - Normalized phone number (9647XXXXXXXX)
 */
 ...
 */
export function isValidPhoneNumber(phone, countryCode = DEFAULT_COUNTRY_CODE) {
 ...
 * @param {string} countryCode - Country code (default: 964)
 * @returns {string} - Local part (7XXXXXXXX for Iraq)
 */
export function getLocalNumber(phone, countryCode = DEFAULT_COUNTRY_CODE) {
    if (!phone) return '';
 ...
 * @param {string} phone - Phone number
 * @returns {string} - Country code or default (964)
 */
