-- Migration: Add SetIsActive column to V_AllSets and include inactive sets
-- Date: 2025-12-21
-- Purpose: Allow viewing inactive sets (hidden by default in UI)
-- Change: Added SetIsActive column, removed IsActive=1 filter
