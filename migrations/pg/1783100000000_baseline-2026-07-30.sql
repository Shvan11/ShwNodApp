-- ===========================================================================
-- SQUASHED BASELINE — the full application schema as of 2026-07-30.
--
...
--
-- It replaces these 21 files, whose contents remain in git history at f83e10a:
...
CREATE TABLE public.aligner_activity_flags (
    ...
    updated_at timestamp without time zone,
    source public.citext DEFAULT 'staff'::public.citext NOT NULL,
    CONSTRAINT aligner_activity_flags_source_check CHECK ((source OPERATOR(public.=) ANY (ARRAY['staff'::public.citext, 'portal'::public.citext]))),
    CONSTRAINT ck_activitytype CHECK ((activity_type OPERATOR(public.=) ANY (ARRAY['DaysChanged'::public.citext, 'DoctorNote'::public.citext, 'PhotoUploaded'::public.citext, 'FileUploaded'::public.citext, 'CaseSubmitted'::public.citext])))
);
...
CREATE TABLE public.approval_requests (
    ...
    requested_at timestamp without time zone DEFAULT LOCALTIMESTAMP NOT NULL,
    status text DEFAULT 'pending'::text NOT NULL,
    reviewed_by text,
    reviewed_at timestamp without time zone,
    review_note text,
    CONSTRAINT approval_requests_kind_check CHECK ((kind = ANY (ARRAY['approval'::text, 'notice'::text]))),
    CONSTRAINT approval_requests_status_check CHECK ((status = ANY (ARRAY['pending'::text, 'approved'::text, 'rejected'::text, 'acknowledged'::text, 'failed'::text, 'stale'::text])))
);
...
ALTER TABLE public.approval_requests ALTER COLUMN request_id ADD GENERATED BY DEFAULT AS IDENTITY (
...
--
-- Name: doctor_announcement_reads; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.doctor_announcement_reads (
    read_id integer NOT NULL,
    announcement_id integer NOT NULL,
    dr_id integer NOT NULL,
    read_at timestamp without time zone DEFAULT LOCALTIMESTAMP NOT NULL,
    updated_at timestamp without time zone
);


--
-- Name: doctor_announcement_reads_read_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.doctor_announcement_reads ALTER COLUMN read_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.doctor_announcement_reads_read_id_seq
    START WITH 1
    INCREMENT BY 2
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: doctor_announcements; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.doctor_announcements (
    announcement_id integer NOT NULL,
    title text NOT NULL,
    message text NOT NULL,
    announcement_type text DEFAULT 'info'::text NOT NULL,
    ...
    CONSTRAINT doctor_announcements_announcement_type_check CHECK ((announcement_type = ANY (ARRAY['success'::text, 'info'::text, 'warning'::text, 'urgent'::text]))),
    CONSTRAINT doctor_announcements_auto_event_check CHECK ((auto_event = ANY (ARRAY['batch_manufactured'::text, 'batch_delivered'::text])))
);


--
-- Name: doctor_announcements_announcement_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.doctor_announcements ALTER COLUMN announcement_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.doctor_announcements_announcement_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.employees (
    ...
    CONSTRAINT chk_employees_commission_pct CHECK (((commission_percentage IS NULL) OR ((commission_percentage >= 1) AND (commission_percentage <= 100))))
);
...
CREATE TABLE public.expense_categories (
    ...
    category_name_ar public.citext
);
...
CREATE TABLE public.expense_subcategories (
    ...
    subcategory_name_ar public.citext
);
...
--
-- Name: lab_case_events; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.lab_case_events (
    ...
    from_status text,
    to_status text,
    occurred_at timestamp without time zone DEFAULT LOCALTIMESTAMP NOT NULL,
    note text,
    created_by text,
    created_at timestamp without time zone DEFAULT LOCALTIMESTAMP NOT NULL,
    CONSTRAINT lab_case_events_event_type_check CHECK ((event_type = ANY (ARRAY['stage_change'::text, 'remake'::text, 'hold'::text, 'resume'::text, 'note'::text, 'cancel'::text])))
);


--
-- Name: lab_case_events_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.lab_case_events ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.lab_case_events_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: lab_cases; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.lab_cases (
    ...
    lab_id integer,
    material text,
    status text DEFAULT 'sent_to_lab'::text NOT NULL,
    is_on_hold boolean DEFAULT false NOT NULL,
    is_rush boolean DEFAULT false NOT NULL,
    due_date date,
    sent_at timestamp without time zone DEFAULT LOCALTIMESTAMP NOT NULL,
    delivered_at timestamp without time zone,
    remake_count integer DEFAULT 0 NOT NULL,
    status_changed_at timestamp without time zone DEFAULT LOCALTIMESTAMP NOT NULL,
    note text,
    created_at timestamp without time zone DEFAULT LOCALTIMESTAMP NOT NULL,
    created_by text,
    delivered_by text,
    CONSTRAINT lab_cases_status_check CHECK ((status = ANY (ARRAY['sent_to_lab'::text, 'wax_up_tryin'::text, 'pattern_fab'::text, 'plastic_check'::text, 'framework_fab'::text, 'framework_tryin'::text, 'ceramic_buildup'::text, 'bisque_tryin'::text, 'glaze'::text, 'ready'::text, 'delivered'::text, 'cancelled'::text])))
);


--
-- Name: lab_cases_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.lab_cases ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.lab_cases_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.labs ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
...
CREATE TABLE public.patient_types (
    ...
    patient_type_name_ar public.citext
);
...
--
-- Name: shade_3d_master; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.shade_3d_master (
    id integer NOT NULL,
...
--
-- Name: shade_3d_master_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.shade_3d_master ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.shade_3d_master_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: shade_vita_classic; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.shade_vita_classic (
    id integer NOT NULL,
    shade public.citext NOT NULL
);
...
--
-- Name: shade_vita_classic_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.shade_vita_classic ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.shade_vita_classic_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: slideshow_configs; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.slideshow_configs (
    id integer NOT NULL,
    person_id integer,
    ...
    created_at timestamp without time zone DEFAULT LOCALTIMESTAMP NOT NULL,
    CONSTRAINT slideshow_configs_kind_check CHECK ((kind = ANY (ARRAY['literal'::text, 'template'::text])))
);


--
-- Name: slideshow_configs_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.slideshow_configs ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.slideshow_configs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.users (
    ...
    role public.citext DEFAULT 'front_desk'::public.citext,
    is_active boolean DEFAULT true,
    last_login timestamp without time zone,
    created_at timestamp without time zone DEFAULT LOCALTIMESTAMP,
    created_by public.citext,
    CONSTRAINT chk_users_role CHECK ((role OPERATOR(public.=) ANY (ARRAY['admin'::public.citext, 'front_desk'::public.citext, 'clinical'::public.citext])))
);
...
--
-- Name: doctor_announcement_reads doctor_announcement_reads_announcement_id_dr_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.doctor_announcement_reads
    ADD CONSTRAINT doctor_announcement_reads_announcement_id_dr_id_key UNIQUE (announcement_id, dr_id);


--
-- Name: doctor_announcement_reads doctor_announcement_reads_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.doctor_announcement_reads
    ADD CONSTRAINT doctor_announcement_reads_pkey PRIMARY KEY (read_id);


--
-- Name: doctor_announcements doctor_announcements_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.doctor_announcements
    ADD CONSTRAINT doctor_announcements_pkey PRIMARY KEY (announcement_id);
...
ALTER TABLE ONLY public.integration_oauth_tokens
    ADD CONSTRAINT integration_oauth_tokens_pkey PRIMARY KEY (provider);
...
--
-- Name: lab_case_events lab_case_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.lab_case_events
    ADD CONSTRAINT lab_case_events_pkey PRIMARY KEY (id);


--
-- Name: lab_cases lab_cases_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: lab_cases lab_cases_work_item_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.lab_cases
    ADD CONSTRAINT lab_cases_work_item_id_key UNIQUE (work_item_id);
...
--
-- Name: shade_3d_master shade_3d_master_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.shade_3d_master
    ADD CONSTRAINT shade_3d_master_pkey PRIMARY KEY (id);


--
-- Name: shade_vita_classic shade_vita_classic_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.shade_vita_classic
    ADD CONSTRAINT shade_vita_classic_pkey PRIMARY KEY (id);


--
-- Name: slideshow_configs slideshow_configs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.slideshow_configs
    ADD CONSTRAINT slideshow_configs_pkey PRIMARY KEY (id);
...
--
-- Name: ix_activity_portal_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_activity_portal_created ON public.aligner_activity_flags USING btree (created_at DESC) WHERE (source OPERATOR(public.=) 'portal'::public.citext);


--
-- Name: ix_alerts_active_person; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_alerts_active_person ON public.alerts USING btree (person_id) WHERE (status = 'active'::text);
...
--
-- Name: ix_announcement_reads_dr; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_announcement_reads_dr ON public.doctor_announcement_reads USING btree (dr_id);


--
-- Name: ix_announcements_auto_batch; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_announcements_auto_batch ON public.doctor_announcements USING btree (related_batch_id) WHERE (auto_event IS NOT NULL);


--
-- Name: ix_announcements_target_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_announcements_target_created ON public.doctor_announcements USING btree (target_doctor_id, created_at DESC);
...
--
-- Name: ix_appointments_drid_appdate; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_appointments_drid_appdate ON public.appointments USING btree (dr_id, app_date) WHERE (dr_id IS NOT NULL);


--
-- Name: ix_approval_requests_pending; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_approval_requests_pending ON public.approval_requests USING btree (request_id) WHERE (status = 'pending'::text);


--
-- Name: ix_approval_requests_requested_by; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_approval_requests_requested_by ON public.approval_requests USING btree (requested_by, requested_at DESC);
...
CREATE INDEX ix_expenses_employee_id ON public.expenses USING btree (employee_id) WHERE (employee_id IS NOT NULL);
...
--
-- Name: ix_expenses_lab_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_expenses_lab_id ON public.expenses USING btree (lab_id) WHERE (lab_id IS NOT NULL);
...
--
-- Name: ix_lab_case_events_case_occurred; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_lab_case_events_case_occurred ON public.lab_case_events USING btree (lab_case_id, occurred_at);


--
-- Name: ix_lab_cases_open_due_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_lab_cases_open_due_date ON public.lab_cases USING btree (due_date) WHERE (status <> ALL (ARRAY['delivered'::text, 'cancelled'::text]));


--
-- Name: ix_lab_cases_open_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_lab_cases_open_status ON public.lab_cases USING btree (status) WHERE (status <> ALL (ARRAY['delivered'::text, 'cancelled'::text]));


--
-- Name: ix_lab_cases_person; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_lab_cases_person ON public.lab_cases USING btree (person_id);
...
--
-- Name: ix_slideshow_configs_person; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_slideshow_configs_person ON public.slideshow_configs USING btree (person_id);
...
CREATE INDEX ix_tblappointments_messageid ON public.appointments USING btree (wa_message_id) WHERE (wa_message_id IS NOT NULL);
...
--
-- Name: ix_works_dr_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_works_dr_id ON public.works USING btree (dr_id);
...
--
-- Name: approval_requests trg_cdc_capture; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_cdc_capture AFTER INSERT OR DELETE OR UPDATE ON public.approval_requests FOR EACH ROW EXECUTE FUNCTION public.cdc_capture('request_id', 'failover');
...
--
-- Name: doctor_announcement_reads trg_cdc_capture; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_cdc_capture AFTER INSERT OR DELETE OR UPDATE ON public.doctor_announcement_reads FOR EACH ROW EXECUTE FUNCTION public.cdc_capture('read_id', 'failover');


--
-- Name: doctor_announcements trg_cdc_capture; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_cdc_capture AFTER INSERT OR DELETE OR UPDATE ON public.doctor_announcements FOR EACH ROW EXECUTE FUNCTION public.cdc_capture('announcement_id', 'failover');
...
--
-- Name: lab_case_events trg_cdc_capture; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_cdc_capture AFTER INSERT OR DELETE OR UPDATE ON public.lab_case_events FOR EACH ROW EXECUTE FUNCTION public.cdc_capture('id', 'failover');


--
-- Name: lab_cases trg_cdc_capture; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_cdc_capture AFTER INSERT OR DELETE OR UPDATE ON public.lab_cases FOR EACH ROW EXECUTE FUNCTION public.cdc_capture('id', 'failover');


--
-- Name: labs trg_cdc_capture; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_cdc_capture AFTER INSERT OR DELETE OR UPDATE ON public.labs FOR EACH ROW EXECUTE FUNCTION public.cdc_capture('id', 'failover');
...
--
-- Name: shade_3d_master trg_cdc_capture; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_cdc_capture AFTER INSERT OR DELETE OR UPDATE ON public.shade_3d_master FOR EACH ROW EXECUTE FUNCTION public.cdc_capture('id', 'failover');


--
-- Name: shade_vita_classic trg_cdc_capture; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_cdc_capture AFTER INSERT OR DELETE OR UPDATE ON public.shade_vita_classic FOR EACH ROW EXECUTE FUNCTION public.cdc_capture('id', 'failover');


--
-- Name: slideshow_configs trg_cdc_capture; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_cdc_capture AFTER INSERT OR DELETE OR UPDATE ON public.slideshow_configs FOR EACH ROW EXECUTE FUNCTION public.cdc_capture('id', 'failover');
...
--
-- Name: doctor_announcement_reads trg_set_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_set_updated_at BEFORE INSERT OR UPDATE ON public.doctor_announcement_reads FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
...
--
-- Name: doctor_announcement_reads doctor_announcement_reads_announcement_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.doctor_announcement_reads
    ADD CONSTRAINT doctor_announcement_reads_announcement_id_fkey FOREIGN KEY (announcement_id) REFERENCES public.doctor_announcements(announcement_id) ON DELETE CASCADE;


--
-- Name: doctor_announcement_reads doctor_announcement_reads_dr_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.doctor_announcement_reads
    ADD CONSTRAINT doctor_announcement_reads_dr_id_fkey FOREIGN KEY (dr_id) REFERENCES public.aligner_doctors(dr_id) ON DELETE CASCADE;


--
-- Name: doctor_announcements doctor_announcements_target_doctor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.doctor_announcements
    ADD CONSTRAINT doctor_announcements_target_doctor_id_fkey FOREIGN KEY (target_doctor_id) REFERENCES public.aligner_doctors(dr_id) ON DELETE CASCADE;
...
--
-- Name: expenses expenses_lab_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.expenses
    ADD CONSTRAINT expenses_lab_id_fkey FOREIGN KEY (lab_id) REFERENCES public.labs(id);
...
--
-- Name: lab_case_events lab_case_events_lab_case_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.lab_case_events
    ADD CONSTRAINT lab_case_events_lab_case_id_fkey FOREIGN KEY (lab_case_id) REFERENCES public.lab_cases(id) ON DELETE CASCADE;


--
-- Name: lab_cases lab_cases_lab_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.lab_cases
    ADD CONSTRAINT lab_cases_lab_id_fkey FOREIGN KEY (lab_id) REFERENCES public.labs(id);


--
-- Name: lab_cases lab_cases_person_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.lab_cases
    ADD CONSTRAINT lab_cases_person_id_fkey FOREIGN KEY (person_id) REFERENCES public.patients(person_id);


--
-- Name: lab_cases lab_cases_work_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.lab_cases
    ADD CONSTRAINT lab_cases_work_item_id_fkey FOREIGN KEY (work_item_id) REFERENCES public.work_items(id) ON DELETE CASCADE;
...
--
-- Name: slideshow_configs slideshow_configs_person_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.slideshow_configs
    ADD CONSTRAINT slideshow_configs_person_id_fkey FOREIGN KEY (person_id) REFERENCES public.patients(person_id) ON DELETE CASCADE;
...
--
-- Name: work_items work_items_lab_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.work_items
    ADD CONSTRAINT work_items_lab_id_fkey FOREIGN KEY (lab_id) REFERENCES public.labs(id);
...
INSERT INTO public.shade_3d_master (shade) VALUES
  ('0M1'), ('0M2'), ('0M3'), ('1M1'), ('1M2'), ('2L1.5'), ('2L2.5'),
  ('2M1'), ('2M2'), ('2M3'), ('2R1.5'), ('2R2.5'), ('3L1.5'), ('3L2.5'),
  ('3M1'), ('3M2'), ('3M3'), ('3R1.5'), ('3R2.5'), ('4L1.5'), ('4L2.5'),
  ('4M1'), ('4M2'), ('4M3'), ('4R1.5'), ('4R2.5'), ('5M1'), ('5M2'),
  ('5M3')
  ON CONFLICT DO NOTHING;
...
SELECT NULL, 'Smile — Initial & Final', 'template', '{"kind": "template", "slides": [{"photos": [{"tp": "first", "type": "i13"}, {"tp": "latest", "type": "i13"}]}]}'::jsonb
WHERE NOT EXISTS (
  SELECT 1 FROM public.slideshow_configs WHERE person_id IS NULL AND name = 'Smile — Initial & Final'
);

INSERT INTO public.slideshow_configs (person_id, name, kind, config)
SELECT NULL, 'Profile — Initial & Final', 'template', '{"kind": "template", "slides": [{"photos": [{"tp": "first", "type": "i10"}, {"tp": "latest", "type": "i10"}]}]}'::jsonb
WHERE NOT EXISTS (
