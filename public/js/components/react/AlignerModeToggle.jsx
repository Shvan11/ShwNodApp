// AlignerModeToggle.jsx - Reusable mode toggle buttons for aligner section
import React from 'react';
import { useNavigate } from 'react-router-dom';

/**
 * Mode toggle component for aligner section navigation
 *
 * @param {Object} props
 * @param {string} props.activeMode - Current active mode: 'doctors' | 'all-sets' | 'search'
 */
const AlignerModeToggle = ({ activeMode }) => {
