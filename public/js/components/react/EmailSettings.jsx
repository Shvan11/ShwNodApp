...
const EmailSettings = ({ onChangesUpdate }) => {
    ...
    const loadEmailConfig = useCallback(async () => {
        ...
        try {
            ...
            showModal('Error', 'Failed to load email settings: ' + error.message, 'error');
        } finally {
            setIsLoading(false);
        }
    }, []);
    ...
    const saveChanges = async () => {
        ...
        try {
            ...
            showModal('Error', 'Failed to save email configuration: ' + error.message, 'error');
        } finally {
            setIsLoading(false);
        }
    };
    ...
    const testConnection = async () => {
        ...
        try {
            ...
            showModal('Error', 'Connection test failed: ' + error.message, 'error');
        } finally {
            setIsTesting(false);
        }
    };
    ...
    const sendTestEmail = async () => {
        ...
        try {
            ...
            showModal('Error', 'Failed to send test email: ' + error.message, 'error');
        } finally {
            setIsSending(false);
        }
    };
    ...
    const getCurrentValue = (fieldName) => {
        return pendingChanges.hasOwnProperty(fieldName) ? pendingChanges[fieldName] : (config[fieldName] || '');
    };
