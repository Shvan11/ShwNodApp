 ...
 */
export function requestTimeout(timeout = TIMEOUTS.DEFAULT) {
    return (req, res, next) => {
        ...
        req.setTimeout(timeout, () => {
            ...
            if (!res.headersSent) {
                ...
                return ErrorResponses.sendError(res, 408, 'Request timeout exceeded', {
                    timeout: `${timeout}ms`,
                    method: req.method,
                    url: req.url
                });
        ...
        res.setTimeout(timeout, () => {
            ...
            if (!res.headersSent) {
                return ErrorResponses.sendError(res, 408, 'Response timeout exceeded', {
                    timeout: `${timeout}ms`,
                    method: req.method,
                    url: req.url
                });
 ...
 */
export function customTimeout(ms) {
