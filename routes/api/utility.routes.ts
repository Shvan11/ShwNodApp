...
router.get('/sendtwilio', async (req: Request<object, unknown, unknown, DateQuery>, res: Response): Promise<void> => {
  ...
  try {
    ...
    ErrorResponses.internalError(res, 'Failed to send SMS', error as Error);
  }
});
...
router.get('/checktwilio', async (req: Request<object, unknown, unknown, DateQuery>, res: Response): Promise<void> => {
  ...
  try {
    ...
    ErrorResponses.internalError(res, 'Failed to check SMS', error as Error);
  }
});
...
router.get('/convert-path', async (req: Request<object, unknown, unknown, PathQuery>, res: Response): Promise<void> => {
  try {
    ...
    if (!config.fileSystem.machinePath) {
      ...
      ErrorResponses.internalError(res, 'MACHINE_PATH environment variable not configured');
      return;
    }
    ...
    ErrorResponses.internalError(res, 'Internal server error', error as Error);
  }
});
